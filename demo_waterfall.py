...
SCALE = (1e6, 'MHz')
SCALE = (1e3, 'kHz')
FREQ_INC_COARSE = SCALE[0]
FREQ_INC_FINE = SCALE[0]/10
GAIN_INC = 5
ZOOM = 5
...
class Waterfall(object):
    ...
    def init_plot(self):
        ...
        self.ax.set_xlabel('Current frequency (%s)' % SCALE[1])
        self.ax.get_yaxis().set_visible(False)

    def update_plot_labels(self):
        fc = self.sdr.fc
        rs = self.sdr.rs
        freq_range = (fc - rs/2)/SCALE[0]/ZOOM, (fc + rs*(NUM_SCANS_PER_SWEEP - 0.5))/SCALE[0]/ZOOM
