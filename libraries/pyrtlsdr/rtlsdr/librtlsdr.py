...
#/* register and GPIO functions */
# uint16_t rtlsdr_read_reg(rtlsdr_dev_t *dev, uint8_t block, uint16_t addr, uint8_t len)
f = librtlsdr.rtlsdr_read_reg
f.restype, f.argtypes = c_uint16, [p_rtlsdr_dev, c_uint8, c_uint16, c_uint8]

# int rtlsdr_write_reg(rtlsdr_dev_t *dev, uint8_t block, uint16_t addr, uint16_t val, uint8_t len)
f = librtlsdr.rtlsdr_write_reg
f.restype, f.argtypes = c_int, [p_rtlsdr_dev, c_uint8, c_int16, c_uint16, c_uint8]

# void rtlsdr_set_gpio_bit(rtlsdr_dev_t *dev, uint8_t gpio, int val);
f = librtlsdr.rtlsdr_set_gpio_bit
f.restype, f.argtypes = None, [p_rtlsdr_dev, c_uint8, c_int]

# void rtlsdr_set_gpio_output(rtlsdr_dev_t *dev, uint8_t gpio);
f = librtlsdr.rtlsdr_set_gpio_output
f.restype, f.argtypes = None, [p_rtlsdr_dev, c_uint8]
